...
public class MemoDto {
    ...
    private String memoLastModify;  // memo_last_modify (마지막 수정 날짜)
    ...
    public MemoDto(int memoNo, String memoName, String memoContent, String memoWriterId,
    		String memoWriteDate, String memoLastModify) {
        this.memoNo = memoNo;
    ...
    public String getMemoLastModify() {
        return memoLastModify;
    }

    public void setMemoLastModify(String memoLastModify) {
        this.memoLastModify = memoLastModify;
    }
